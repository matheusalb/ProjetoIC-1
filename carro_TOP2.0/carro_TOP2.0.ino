...
void loop() {
  ...
  if (distancia <= 17 && flagObstaculo) {
    ...
    do {
      para();
      digitalWrite(LED_OBSTACULO, LOW);
    } while (millis() - tempo > 800 && millis() - tempo < 950);
    do {
      // Giro para Esquerda
      digitalWrite(LED_OBSTACULO, HIGH);
      analogWrite(MOTOR_EV, VELOCIDADE_MAX_OBST);
    ...
    } while (millis() - tempo > 950 && millis() - tempo < 1150);
    do {
      para();
      digitalWrite(LED_OBSTACULO, LOW);
    } while (millis() - tempo > 1150 && millis() - tempo < 1300);
    do {
      // Frente
      analogWrite(MOTOR_EV, VELOCIDADE_MAX_OBST);
      analogWrite(MOTOR_DV, VELOCIDADE_MAX_OBST);
      ...
      digitalWrite(MOTOR_D1, LOW);
      digitalWrite(MOTOR_D2, HIGH);
    } while (millis() - tempo > 1300 && millis() - tempo < 1800);
    do {
      para();
      digitalWrite(LED_OBSTACULO, LOW);
    } while (millis() - tempo > 1800 && millis() - tempo < 1950);
    do {
      // Giro para Esquerda
      digitalWrite(LED_OBSTACULO, HIGH);
      analogWrite(MOTOR_EV, VELOCIDADE_MAX_OBST);
      ...
      digitalWrite(MOTOR_D1, HIGH);
      digitalWrite(MOTOR_D2, LOW);
    } while (millis() - tempo > 1950 && millis() - tempo < 2000);
    do {
      para();
      digitalWrite(LED_OBSTACULO, LOW);
    ...
    do {
      // Frente
      analogWrite(MOTOR_EV, 45);
      analogWrite(MOTOR_DV, 40);
      digitalWrite(MOTOR_E1, LOW);
      digitalWrite(MOTOR_E2, HIGH);
      digitalWrite(MOTOR_D1, LOW);
      digitalWrite(MOTOR_D2, HIGH);
    ...
    do {
      ...
      digitalWrite(MOTOR_D1, LOW);
      digitalWrite(MOTOR_D2, HIGH);
    //} while (millis() - tempo > 150 && millis() - tempo < 850);
    } while (digitalRead(IN_PIN) == HIGH);
    //if (millis() - tempo >= 850) {
      para();
      digitalWrite(LED_OBSTACULO, LOW);
